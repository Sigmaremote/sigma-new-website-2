...
export const metadata: Metadata = {
  title: "SigmaRemote vs Rippling - Lower Costs, Faster Global Payroll",
  description:
    "See why scaling teams choose SigmaRemote over Rippling for predictable costs, faster onboarding, and flexible USD wallet payouts.",
  metadataBase: new URL("https://sigmaremote.com"),
  alternates: { canonical: "/compare/rippling" },
  openGraph: {
    title: "SigmaRemote vs Rippling - Lower Costs, Faster Global Payroll",
    url: "https://sigmaremote.com/compare/rippling",
    images: ["/og-compare-rippling.jpg"],
  },
  twitter: { card: "summary_large_image" },
};

export default function Page() {
  const d = COMPARE_DATA["rippling"];
  
  const json = [
    {
      "@context": "https://schema.org",
      "@type": "WebPage",
      "name": "SigmaRemote vs Rippling - comparison",
      "url": "https://sigmaremote.com/compare/rippling"
    },
    {
      "@context": "https://schema.org",
      ...
      "itemListElement": [
        ...
        { "@type": "ListItem", "position": 3, "name": "Rippling", "item": "https://sigmaremote.com/compare/rippling" }
      ]
    },
    {
      "@context": "https://schema.org",
      "@type": "Article",
      "headline": "SigmaRemote vs Rippling - Lower Costs, Faster Global Payroll",
      "datePublished": "2025-10-14T00:00:00+02:00",
      "mainEntityOfPage": { "@type": "WebPage", "@id": "https://sigmaremote.com/compare/rippling" },
      "author": { "@type": "Person", "name": "SigmaRemote", "url": "https://sigmaremote.com" },
      "publisher": { "@type": "Organization", "name": "SigmaRemote" },
      "image": "https://sigmaremote.com/og-compare-rippling.jpg",
      "inLanguage": "en"
    }
  ];
  ...
  return (
    <>
      <Script id="ld-compare-rippling" type="application/ld+json" dangerouslySetInnerHTML={{ __html: JSON.stringify(json) }} />
      <FadeIn>
        <AnimatedSection animation="fadeUp" delay={0}>
          <CompareHero competitorKey="rippling" />
        </AnimatedSection>
        
        <AnimatedSection animation="fadeUp" delay={100}>
          <CompareSection competitorKey="rippling" />
        </AnimatedSection>
