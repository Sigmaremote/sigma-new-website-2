...
export const metadata: Metadata = {
  title: "SigmaRemote vs Payoneer - Lower Costs, Faster Global Payroll",
  description:
    "See why scaling teams choose SigmaRemote over Payoneer for predictable costs, faster onboarding, and flexible USD wallet payouts.",
  metadataBase: new URL("https://sigmaremote.com"),
  alternates: { canonical: "/compare/payoneer" },
  openGraph: {
    title: "SigmaRemote vs Payoneer - Lower Costs, Faster Global Payroll",
    url: "https://sigmaremote.com/compare/payoneer",
    images: ["/og-compare-payoneer.jpg"],
  },
  twitter: { card: "summary_large_image" },
};

export default function Page() {
  const d = COMPARE_DATA["payoneer"];
  
  const json = [
    {
      "@context": "https://schema.org",
      "@type": "WebPage",
      "name": "SigmaRemote vs Payoneer - comparison",
      "url": "https://sigmaremote.com/compare/payoneer"
    },
    {
      "@context": "https://schema.org",
      ...
      "itemListElement": [
        ...
        { "@type": "ListItem", "position": 3, "name": "Payoneer", "item": "https://sigmaremote.com/compare/payoneer" }
      ]
    },
    {
      "@context": "https://schema.org",
      "@type": "Article",
      "headline": "SigmaRemote vs Payoneer - Lower Costs, Faster Global Payroll",
      "datePublished": "2025-10-14T00:00:00+02:00",
      "mainEntityOfPage": { "@type": "WebPage", "@id": "https://sigmaremote.com/compare/payoneer" },
      "author": { "@type": "Person", "name": "SigmaRemote", "url": "https://sigmaremote.com" },
      "publisher": { "@type": "Organization", "name": "SigmaRemote" },
      "image": "https://sigmaremote.com/og-compare-payoneer.jpg",
      "inLanguage": "en"
    }
  ];
  ...
  return (
    <>
      <Script id="ld-compare-payoneer" type="application/ld+json" dangerouslySetInnerHTML={{ __html: JSON.stringify(json) }} />
      <FadeIn>
        <AnimatedSection animation="fadeUp" delay={0}>
          <CompareHero competitorKey="payoneer" />
        </AnimatedSection>
        
        <AnimatedSection animation="fadeUp" delay={100}>
          <CompareSection competitorKey="payoneer" />
        </AnimatedSection>
