...
export const metadata: Metadata = {
  title: "SigmaRemote vs Veem - Lower Costs, Faster Global Payroll",
  description:
    "See why scaling teams choose SigmaRemote over Veem for predictable costs, faster onboarding, and flexible USD wallet payouts.",
  metadataBase: new URL("https://sigmaremote.com"),
  alternates: { canonical: "/compare/veem" },
  openGraph: {
    title: "SigmaRemote vs Veem - Lower Costs, Faster Global Payroll",
    url: "https://sigmaremote.com/compare/veem",
    images: ["/og-compare-veem.jpg"],
  },
  twitter: { card: "summary_large_image" },
};

export default function Page() {
  const d = COMPARE_DATA["veem"];
  
  const json = [
    {
      "@context": "https://schema.org",
      "@type": "WebPage",
      "name": "SigmaRemote vs Veem - comparison",
      "url": "https://sigmaremote.com/compare/veem"
    },
    {
      "@context": "https://schema.org",
      ...
      "itemListElement": [
        ...
        { "@type": "ListItem", "position": 3, "name": "Veem", "item": "https://sigmaremote.com/compare/veem" }
      ]
    },
    {
      "@context": "https://schema.org",
      "@type": "Article",
      "headline": "SigmaRemote vs Veem - Lower Costs, Faster Global Payroll",
      "datePublished": "2025-10-14T00:00:00+02:00",
      "mainEntityOfPage": { "@type": "WebPage", "@id": "https://sigmaremote.com/compare/veem" },
      "author": { "@type": "Person", "name": "SigmaRemote", "url": "https://sigmaremote.com" },
      "publisher": { "@type": "Organization", "name": "SigmaRemote" },
      "image": "https://sigmaremote.com/og-compare-veem.jpg",
      "inLanguage": "en"
    }
  ];
    ...
    <>
      ...
      <FadeIn>
        <AnimatedSection animation="fadeUp" delay={0}>
          <CompareHero competitorKey="veem" />
        </AnimatedSection>
        
        <AnimatedSection animation="fadeUp" delay={100}>
          <CompareSection competitorKey="veem" />
        </AnimatedSection>
